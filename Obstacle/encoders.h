...
ISR( INT6_vect ) {
  ...
  switch( state ) {
    case 1:  count_er--; break;  // clockwise?
    case 2:  count_er++; break;  // anti-clockwise?
    case 13: count_er++; break;  // anti-clockwise?
    case 14: count_er--; break;  // clockwise?
...
ISR( PCINT0_vect ) {
  ...
  // against the lecture slides.  
  switch( state ) {
    case 4: count_el++;  break;  // anti-clockwise?
    case 7: count_el--;  break;  // clockwise?
    case 8: count_el--;  break;  // clockwise?
    case 11: count_el++; break;  // anti-clockwise?
    default: break;
  }
